...
void printConexo() {
  printColor("  __  ___   __    __   __   _   _  ___ _   _  __  \n", "35"); //roxo
  printColor(" / _||  __| / _ \\  / _| / _ \\ | \\ | ||  _|\\ \\ / / / _ \\ \n", "35"); //roxo
  printColor("| |  _ | |_   | |  | || |     | |  | ||  \\| || |__    \\ V / | |  | |\n", "35"); //roxo
  printColor("| | |_ ||  _|  | |  | || |     | |  | || . ` ||  _|    > <  | |  | |\n", "35"); //roxo
  printColor("| |_| || |_ | |_| || |_ | |_| || |\\  || |_  / . \\ | |__| |\n", "35"); //roxo
  printColor(" \\__||__| \\_/  \\__| \\_/ || \\||__|// \\\\ \\__/ \n", "35"); //roxo
  printColor("                                                                       \n", "35"); //roxo
  printColor("                                                                       \n", "35"); //roxo
}

void print_voceganhou() {
  printColor("_      _  __    __  ___     __            _   _  _    _   ___   _    _ \n", "35"); //roxo
  printColor("\\ \\    / / / _ \\  / __||  __|   / __|    /\\    | \\ | || |  | | / _ \\ | |  | |\n", "35"); //roxo
  printColor(" \\ \\  / / | |  | || |     | |_     | |  _    /  \\   |  \\| || |__| || |  | || |  | |\n", "35"); //roxo
  printColor("  \\ \\/ /  | |  | || |     |  _|    | | | |  / /\\ \\  | . ` ||  __  || |  | || |  | |\n", "35"); //roxo
  printColor("   \\  /   | |_| || |_ | |__   | |_| | / __ \\ | |\\  || |  | || || || |_| |\n", "35"); //roxo
  printColor("    \\/     \\_/  \\_||__|   \\_|//    \\\\|| \\|||  || \\_/  \\__/ \n", "35"); //roxo
  printf("                                                                                      \n"); //roxo
  printf("                                                                                      \n"); //roxo
}
...
int main(void) {
  ...
  while(acertos<4){
    ...
    if (verificacao(resposta, head1, head2, head3, head4)){
      ...
      id += 5; // a cada 5 posições ele pula linha 
    }
    else{
